...
gyp info using node@24.18.1 | win32 | x64
(node:11332) [DEP0190] DeprecationWarning: Passing args to a child process with shell option true can lead to security vulnerabilities, as the arguments are not escaped, only concatenated.
...
gyp ERR! cwd D:\TheProjects\students_records_management_system\backend\node_modules\ws
